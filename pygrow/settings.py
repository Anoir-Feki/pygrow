...
SECRET_KEY = 'em_+*_334b@b)!8^dmisx=b9hm&d+4+k42uit)ir21birl1t-u'
...
TEMPLATES = [
    dict(BACKEND='django.template.backends.django.DjangoTemplates', DIRS=[BASE_DIR / 'monitoring/templates'],
...
ASGI_APPLICATION = 'pygrow.asgi.application'
...
BOOTSTRAP3 = {
    ...
    'theme_url': '/static/assets/css/bootstrap-flat.min.css',
